# Implementação de Cache para get-sheet-entries

## Resumo

Esta implementação adiciona um sistema de cache no localStorage para otimizar as requisições ao endpoint `/get-sheet-entries`, reduzindo drasticamente o tempo de carregamento nas páginas de dashboard e lançamentos.
