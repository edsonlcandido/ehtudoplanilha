...
var V=Object.defineProperty;var O=(n,e,t)=>e in n?V(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var g=(n,e,t)=>O(n,typeof e!="symbol"?e+"":e,t);import{v as q}from"./auth.js";/* empty css     */import{a as R,s as N,b as P}from"./toast.js";import{r as j}from"./user-menu.js";import{a as L,j as B,k as z,m as U,l as y,n as M,e as H,p as W,i as G,b as J,c as K,d as Q,o as X,f as Y,h as S}from"./fab-menu.js";import"./sheets.js";const Z="modulepreload",ee=function(n){return"/"+n},x={},te=function(e,t,a){let o=Promise.resolve();if(t&&t.length>0){let i=function(d){return Promise.all(d.map(m=>Promise.resolve(m).then(E=>({status:"fulfilled",value:E}),E=>({status:"rejected",reason:E}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),r=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));o=i(t.map(d=>{if(d=ee(d),d in x)return;x[d]=!0;const m=d.endsWith(".css"),E=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${E}`))return;const u=document.createElement("link");if(u.rel=m?"stylesheet":Z,m||(u.as="script"),u.crossOrigin="",u.href=d,r&&u.setAttribute("nonce",r),document.head.appendChild(u),m)return new Promise((v,b)=>{u.addEventListener("load",v),u.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${d}`)))})}))}function c(i){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=i,window.dispatchEvent(s),!s.defaultPrevented)throw i}return o.then(i=>{for(const s of i||[])s.status==="rejected"&&c(s.reason);return e().catch(c)})};let f=null;class ne{constructor(){g(this,"modal",null);g(this,"form",null);g(this,"callback");g(this,"currentEntry",null);g(this,"accounts",[]);g(this,"categories",[]);g(this,"categoriesComplete",[]);g(this,"descriptions",[]);g(this,"entries",[])}getTemplate(){return`
  ...
  `}function re(n){return`
    ${ie(n)}
    ${le(n)}
  `}const l={entries:[],filteredEntries:[],originalEntries:[],searchTerm:"",sortBy:"original",showConsolidated:!0,showFuture:!1,isLoading:!1};function ce(){const n=document.getElementById("loadingIndicator");n&&(n.style.display="flex")}function de(){const n=document.getElementById("loadingIndicator");n&&(n.style.display="none")}function _(n,e="info"){e==="success"?R(n):e==="error"?N(n):P(n,"Info")}function me(){const n=document.getElementById("searchResults"),e=document.getElementById("searchCount"),t=document.getElementById("clearSearchBtn");!n||!e||!t||(l.searchTerm?(e.textContent=`${l.filteredEntries.length} resultado(s) encontrado(s)`,n.classList.add("lancamentos__search-results--visible"),t.style.display="flex"):(n.classList.remove("lancamentos__search-results--visible"),t.style.display="none"))}async function p(n=!1){if(!l.isLoading){l.isLoading=!0,l.entries=[],C(),n||ce();try{const a=((await y.fetchEntries(0,n)).entries||[]).filter(c=>!y.isBlankEntry(c));l.originalEntries=a,l.entries=[...l.originalEntries],h(),_("Lançamentos carregados com sucesso"+(n?" (cache atualizado)":""),"success")}catch(e){console.error("Erro ao carregar lançamentos:",e),_("Erro ao carregar lançamentos: "+e.message,"error"),l.entries=[],l.filteredEntries=[],C()}finally{l.isLoading=!1,n||de()}}}function h(){let n=[...l.originalEntries];n=n.filter(e=>e.data!==null&&e.data!==void 0&&!(typeof e.data=="string"&&e.data.trim()==="")?l.showConsolidated:l.showFuture),n=y.sortEntries(n,l.sortBy),l.searchTerm&&(n=y.filterEntries(n,l.searchTerm)),l.filteredEntries=n,l.entries=n,C(),me()}function C(){const n=document.getElementById("entriesContainer");if(!n)return;const t=l.filteredEntries.slice(0,100);n.innerHTML=re(t)}function ue(n){l.sortBy=n,h()}function ge(n){l.showConsolidated=n,h()}function fe(n){l.showFuture=n,h()}function I(n){l.searchTerm=n.trim(),h()}function ye(){const n=document.getElementById("searchInput");n&&(n.value=""),l.searchTerm="",h()}function pe(n){const e=l.originalEntries.find(t=>t.rowIndex===n);e?oe(e):console.error("Lançamento não encontrado:",n)}function Ee(n){const e=l.originalEntries.find(t=>t.rowIndex===n);if(e){const t={conta:e.conta,valor:e.valor,descricao:e.descricao,categoria:e.categoria,orcamento:e.orcamento,obs:e.obs};W(t)}else console.error("Lançamento não encontrado para copiar:",n)}let w=null;function he(n){const e=l.originalEntries.find(s=>s.rowIndex===n);if(!e){console.error("Lançamento não encontrado:",n);return}w=n;const t=document.getElementById("deleteRowNumber"),a=document.getElementById("deleteDate"),o=document.getElementById("deleteValue"),c=document.getElementById("deleteDescription");if(t&&(t.textContent=String(e.rowIndex||"-")),a){let s="-";e.data&&(typeof e.data=="number"?s=M(e.data):typeof e.data=="string"&&(s=e.data)),a.textContent=s}o&&(o.textContent=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e.valor)),c&&(c.textContent=e.descricao||"-");const i=document.getElementById("deleteModal");i&&(i.style.display="flex")}function $(){w=null;const n=document.getElementById("deleteModal");n&&(n.style.display="none")}async function ve(){if(w===null){console.error("Nenhum lançamento pendente para exclusão");return}const n=w,e=document.getElementById("deleteConfirmBtn");e&&(e.disabled=!0,e.textContent="Excluindo...");try{await y.deleteEntry(n),_("Lançamento excluído com sucesso","success"),$(),await p()}catch(t){console.error("Erro ao deletar lançamento:",t),_("Erro ao deletar lançamento: "+t.message,"error")}finally{e&&(e.disabled=!1,e.textContent="Excluir")}}function be(n){he(n)}window.editEntry=pe;window.copyEntry=Ee;window.deleteEntry=be;window.lancamentosManager={closeDeleteModal:$,confirmDelete:ve,closeSplitModal:()=>{const n=document.getElementById("splitModal");n&&(n.style.display="none")},confirmSplit:()=>{console.warn("Funcionalidade de divisão de parcelas não implementada")}};async function T(){if(console.log("[Lançamentos] Inicializando página..."),!await q()){console.warn("⚠️ Token inválido ou usuário não autenticado");return}j(),await G(r=>{console.log("✅ Lançamento adicionado:",r),p()}),await ae(r=>{console.log("✅ Lançamento editado:",r),p()}),await J(r=>{console.log("✅ Lançamento futuro adicionado:",r),p()}),await K(r=>{console.log("✅ Transferência realizada:",r),p()}),Q(()=>S(),()=>Y(),()=>X());const e=document.getElementById("openAddEntryModalBtn");e&&e.addEventListener("click",()=>{console.log("🔓 Abrindo modal de adicionar lançamento..."),S()});const t=document.getElementById("refreshEntriesBtn");t&&t.addEventListener("click",async()=>{console.log("🔄 Atualizando lançamentos (forceRefresh=true)...");const r=t.innerHTML;t.disabled=!0,t.innerHTML="⏳ Atualizando...";try{await p(!0)}finally{t.disabled=!1,t.innerHTML=r}});const a=document.getElementById("searchInput");a&&a.addEventListener("input",r=>{I(r.target.value)});const o=document.getElementById("clearSearchBtn");o&&o.addEventListener("click",()=>{ye()});const c=document.getElementById("sortSelect");c&&(c.value=l.sortBy,c.addEventListener("change",r=>{ue(r.target.value)}));const i=document.getElementById("showConsolidatedCheck");i&&(i.checked=l.showConsolidated,i.addEventListener("change",r=>{ge(r.target.checked)}));const s=document.getElementById("showFutureCheck");s&&(s.checked=l.showFuture,s.addEventListener("change",r=>{fe(r.target.checked)})),document.addEventListener("entry:edited",()=>{console.log("📝 Entrada editada, recarregando..."),setTimeout(()=>{p()},300)}),await p(),se(l.originalEntries),_e(),console.log("✅ Página de lançamentos inicializada")}function _e(){const n=new URLSearchParams(window.location.search),e=n.get("conta"),t=n.get("categoria");e?(console.log("[Lançamentos] Filtrando por conta:",e),I(e)):t&&(console.log("[Lançamentos] Filtrando por categoria:",t),I(t));const a=document.getElementById("searchInput");a&&(e||t)&&(a.value=e||t||"")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",T):T();
