...
var F=Object.defineProperty;var V=(n,e,t)=>e in n?F(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var g=(n,e,t)=>V(n,typeof e!="symbol"?e+"":e,t);import{v as O}from"./auth.js";import"./sheets.js";import{e as I,j as L,k as R,m as q,l as f,n as D,a as N,i as j,b as P,c as z,d as U,o as H,f as W,h as C}from"./fab-menu.js";import{r as G}from"./user-menu.js";import{a as J,s as K,b as Q}from"./toast.js";const X="modulepreload",Y=function(n){return"/"+n},S={},Z=function(e,t,a){let s=Promise.resolve();if(t&&t.length>0){let l=function(c){return Promise.all(c.map(d=>Promise.resolve(d).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),m=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));s=l(t.map(c=>{if(c=Y(c),c in S)return;S[c]=!0;const d=c.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${p}`))return;const u=document.createElement("link");if(u.rel=d?"stylesheet":X,d||(u.as="script"),u.crossOrigin="",u.href=c,m&&u.setAttribute("nonce",m),document.head.appendChild(u),d)return new Promise((h,b)=>{u.addEventListener("load",h),u.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(l){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=l,window.dispatchEvent(o),!o.defaultPrevented)throw l}return s.then(l=>{for(const o of l||[])o.status==="rejected"&&r(o.reason);return e().catch(r)})};let y=null;class ee{constructor(){g(this,"modal",null);g(this,"form",null);g(this,"callback");g(this,"currentEntry",null);g(this,"accounts",[]);g(this,"categories",[]);g(this,"categoriesComplete",[]);g(this,"descriptions",[]);g(this,"entries",[])}getTemplate(){return`
  ...
  `}function oe(n){return n.length===0?`
    ...
    <div class="lancamentos__table">
      ...
      <div class="lancamentos__table-row">
        ...
        <div class="lancamentos__table-cell">${T(t.data)}</div>
        ...
        <div class="lancamentos__item-header">
          <div class="lancamentos__item-info">
            ...
            <div class="lancamentos__item-row">
              ...
              <span class="lancamentos__item-value">${T(t.data)}</span>
            </div>
            <div class="lancamentos__item-row">
  ...
  `}function ie(n){return`
    ${oe(n)}
    ${se(n)}
  `}const i={entries:[],filteredEntries:[],originalEntries:[],searchTerm:"",sortBy:"original",hideBlankDates:!0,isLoading:!1};function le(){const n=document.getElementById("loadingIndicator");n&&(n.style.display="flex")}function re(){const n=document.getElementById("loadingIndicator");n&&(n.style.display="none")}function _(n,e="info"){e==="success"?J(n):e==="error"?K(n):Q(n,"Info")}function ce(){const n=document.getElementById("searchResults"),e=document.getElementById("searchCount"),t=document.getElementById("clearSearchBtn");!n||!e||!t||(i.searchTerm?(e.textContent=`${i.filteredEntries.length} resultado(s) encontrado(s)`,n.classList.add("lancamentos__search-results--visible"),t.style.display="flex"):(n.classList.remove("lancamentos__search-results--visible"),t.style.display="none"))}async function E(n=!1){if(!i.isLoading){i.isLoading=!0,i.entries=[],B(),le();try{const a=((await f.fetchEntries(0,n)).entries||[]).filter(r=>!f.isBlankEntry(r));i.originalEntries=a,i.entries=[...i.originalEntries],v(),_("Lançamentos carregados com sucesso"+(n?" (cache atualizado)":""),"success")}catch(e){console.error("Erro ao carregar lançamentos:",e),_("Erro ao carregar lançamentos: "+e.message,"error"),i.entries=[],i.filteredEntries=[],B()}finally{i.isLoading=!1,re()}}}function v(){let n=[...i.originalEntries];i.hideBlankDates&&(n=n.filter(e=>!(e.data===null||e.data===void 0||typeof e.data=="string"&&e.data.trim()===""))),n=f.sortEntries(n,i.sortBy),i.searchTerm&&(n=f.filterEntries(n,i.searchTerm)),i.filteredEntries=n,i.entries=i.sortBy==="original"?[...i.originalEntries]:f.sortEntries([...i.originalEntries],i.sortBy),B(),ce()}function B(){const n=document.getElementById("entriesContainer");if(!n)return;const t=(i.searchTerm||i.filteredEntries.length>0?i.filteredEntries:i.entries).slice(0,100);n.innerHTML=ie(t)}function de(n){i.sortBy=n,v()}function me(n){i.hideBlankDates=n,v()}function ue(n){i.searchTerm=n.trim(),v()}function ge(){const n=document.getElementById("searchInput");n&&(n.value=""),i.searchTerm="",v()}function fe(n){const e=i.entries.find(t=>t.rowIndex===n);e?ne(e):console.error("Lançamento não encontrado:",n)}let w=null;function ye(n){const e=i.entries.find(o=>o.rowIndex===n);if(!e){console.error("Lançamento não encontrado:",n);return}w=n;const t=document.getElementById("deleteRowNumber"),a=document.getElementById("deleteDate"),s=document.getElementById("deleteValue"),r=document.getElementById("deleteDescription");if(t&&(t.textContent=String(e.rowIndex||"-")),a){let o="-";e.data&&(typeof e.data=="number"?o=D(e.data):typeof e.data=="string"&&(o=e.data)),a.textContent=o}s&&(s.textContent=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e.valor)),r&&(r.textContent=e.descricao||"-");const l=document.getElementById("deleteModal");l&&(l.style.display="flex")}function $(){w=null;const n=document.getElementById("deleteModal");n&&(n.style.display="none")}async function Ee(){if(w===null){console.error("Nenhum lançamento pendente para exclusão");return}const n=w,e=document.getElementById("deleteConfirmBtn");e&&(e.disabled=!0,e.textContent="Excluindo...");try{await f.deleteEntry(n),_("Lançamento excluído com sucesso","success"),$(),await E()}catch(t){console.error("Erro ao deletar lançamento:",t),_("Erro ao deletar lançamento: "+t.message,"error")}finally{e&&(e.disabled=!1,e.textContent="Excluir")}}function pe(n){ye(n)}window.editEntry=fe;window.deleteEntry=pe;window.lancamentosManager={closeDeleteModal:$,confirmDelete:Ee,closeSplitModal:()=>{const n=document.getElementById("splitModal");n&&(n.style.display="none")},confirmSplit:()=>{console.warn("Funcionalidade de divisão de parcelas não implementada")}};async function x(){if(console.log("[Lançamentos] Inicializando página..."),!await O()){console.warn("⚠️ Token inválido ou usuário não autenticado");return}G(),await j(o=>{console.log("✅ Lançamento adicionado:",o),E()}),await te(o=>{console.log("✅ Lançamento editado:",o),E()}),await P(o=>{console.log("✅ Lançamento futuro adicionado:",o),E()}),await z(o=>{console.log("✅ Transferência realizada:",o),E()}),U(()=>C(),()=>W(),()=>H());const e=document.getElementById("openAddEntryModalBtn");e&&e.addEventListener("click",()=>{console.log("🔓 Abrindo modal de adicionar lançamento..."),C()});const t=document.getElementById("refreshEntriesBtn");t&&t.addEventListener("click",()=>{console.log("🔄 Atualizando lançamentos (forceRefresh=true)..."),E(!0)});const a=document.getElementById("searchInput");a&&a.addEventListener("input",o=>{ue(o.target.value)});const s=document.getElementById("clearSearchBtn");s&&s.addEventListener("click",()=>{ge()});const r=document.getElementById("sortSelect");r&&(r.value=i.sortBy,r.addEventListener("change",o=>{de(o.target.value)}));const l=document.getElementById("hideBlankDatesCheck");l&&(l.checked=i.hideBlankDates,l.addEventListener("change",o=>{me(o.target.checked)})),document.addEventListener("entry:edited",()=>{console.log("📝 Entrada editada, recarregando..."),setTimeout(()=>{E()},300)}),await E(),ae(i.entries),console.log("✅ Página de lançamentos inicializada")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",x):x();
