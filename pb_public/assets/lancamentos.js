...
var P=Object.defineProperty;var V=(n,e,t)=>e in n?P(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var p=(n,e,t)=>V(n,typeof e!="symbol"?e+"":e,t);import{v as q}from"./auth.js";/* empty css     */import{a as N,s as R,b as H}from"./toast.js";import{r as j}from"./user-menu.js";import{a as w,j as S,k as z,m as U,l as E,n as T,e as W,p as Y,i as G,b as J,c as K,d as Q,o as X,f as Z,h as F}from"./fab-menu.js";import"./sheets.js";const ee="modulepreload",te=function(n){return"/"+n},x={},ne=function(e,t,o){let a=Promise.resolve();if(t&&t.length>0){let r=function(c){return Promise.all(c.map(m=>Promise.resolve(m).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),u=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));a=r(t.map(c=>{if(c=te(c),c in x)return;x[c]=!0;const m=c.endsWith(".css"),g=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${g}`))return;const f=document.createElement("link");if(f.rel=m?"stylesheet":ee,m||(f.as="script"),f.crossOrigin="",f.href=c,u&&f.setAttribute("nonce",u),document.head.appendChild(f),m)return new Promise((d,I)=>{f.addEventListener("load",d),f.addEventListener("error",()=>I(new Error(`Unable to preload CSS for ${c}`)))})}))}function s(r){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=r,window.dispatchEvent(l),!l.defaultPrevented)throw r}return a.then(r=>{for(const l of r||[])l.status==="rejected"&&s(l.reason);return e().catch(s)})};let y=null;class oe{constructor(){p(this,"modal",null);p(this,"form",null);p(this,"callback");p(this,"currentEntry",null);p(this,"accounts",[]);p(this,"categories",[]);p(this,"categoriesComplete",[]);p(this,"descriptions",[]);p(this,"entries",[])}getTemplate(){return`
  ...
  `}function ce(n){return`
    ${le(n)}
    ${re(n)}
  `}const i={entries:[],filteredEntries:[],originalEntries:[],searchTerm:"",sortBy:"original",showConsolidated:!0,showFuture:!1,isLoading:!1,filters:{conta:"",dataInicio:"",dataFim:"",orcamento:"",categoria:""},filterPanelOpen:!1};function de(){const n=document.getElementById("loadingIndicator");n&&(n.style.display="flex")}function me(){const n=document.getElementById("loadingIndicator");n&&(n.style.display="none")}function b(n,e="info"){e==="success"?N(n):e==="error"?R(n):H(n,"Info")}function ue(){const n=document.getElementById("searchResults"),e=document.getElementById("searchCount"),t=document.getElementById("clearSearchBtn");!n||!e||!t||(i.searchTerm?(e.textContent=`${i.filteredEntries.length} resultado(s) encontrado(s)`,n.classList.add("lancamentos__search-results--visible"),t.style.display="flex"):(n.classList.remove("lancamentos__search-results--visible"),t.style.display="none"))}async function h(n=!1){if(!i.isLoading){i.isLoading=!0,i.entries=[],C(),n||de();try{const o=((await E.fetchEntries(0,n)).entries||[]).filter(s=>!E.isBlankEntry(s));i.originalEntries=o,i.entries=[...i.originalEntries],he(),ve(),be(),v(),b("Lançamentos carregados com sucesso"+(n?" (cache atualizado)":""),"success")}catch(e){console.error("Erro ao carregar lançamentos:",e),b("Erro ao carregar lançamentos: "+e.message,"error"),i.entries=[],i.filteredEntries=[],C()}finally{i.isLoading=!1,n||me()}}}function v(){let n=[...i.originalEntries];n=_e(n),i.searchTerm&&(n=E.filterEntries(n,i.searchTerm)),n=n.filter(e=>e.data!==null&&e.data!==void 0&&!(typeof e.data=="string"&&e.data.trim()==="")?i.showConsolidated:i.showFuture),n=E.sortEntries(n,i.sortBy),i.filteredEntries=n,i.entries=n,C(),ue()}function C(){const n=document.getElementById("entriesContainer");if(!n)return;const t=i.filteredEntries.slice(0,100);n.innerHTML=ce(t)}function fe(n){i.sortBy=n,v()}function ge(n){i.showConsolidated=n,v()}function pe(n){i.showFuture=n,v()}function L(n){i.searchTerm=n.trim(),v()}function ye(){const n=document.getElementById("searchInput");n&&(n.value=""),i.searchTerm="",v()}function Ee(){const n=document.getElementById("filterPanel"),e=document.getElementById("openFilterPanel");n&&e&&(n.setAttribute("aria-hidden","false"),e.classList.add("active"),i.filterPanelOpen=!0,setTimeout(()=>{const t=n.querySelector("select, input");t&&t.focus()},300))}function _(){const n=document.getElementById("filterPanel"),e=document.getElementById("openFilterPanel");n&&e&&(n.setAttribute("aria-hidden","true"),e.classList.remove("active"),i.filterPanelOpen=!1)}function he(){const n=document.getElementById("filterConta");if(!n)return;const e=new Set;i.originalEntries.forEach(a=>{a.conta&&a.conta.trim()&&e.add(a.conta.trim())});const t=Array.from(e).sort(),o=n.options[0];n.innerHTML="",n.appendChild(o),t.forEach(a=>{const s=document.createElement("option");s.value=a,s.textContent=a,i.filters.conta===a&&(s.selected=!0),n.appendChild(s)})}function ve(){const n=document.getElementById("filterOrcamento");if(!n)return;const e=new Set;i.originalEntries.forEach(a=>{if(a.orcamento){let s="";if(typeof a.orcamento=="number"){const r=w(a.orcamento);r&&(s=`${String(r.getMonth()+1).padStart(2,"0")}/${r.getFullYear()}`)}else typeof a.orcamento=="string"&&(s=a.orcamento.trim());s&&e.add(s)}});const t=Array.from(e).sort().reverse(),o=n.options[0];n.innerHTML="",n.appendChild(o),t.forEach(a=>{const s=document.createElement("option");s.value=a,s.textContent=a,i.filters.orcamento===a&&(s.selected=!0),n.appendChild(s)})}function be(){const n=document.getElementById("filterCategoria");if(!n)return;const e=new Set;i.originalEntries.forEach(a=>{a.categoria&&a.categoria.trim()&&e.add(a.categoria.trim())});const t=Array.from(e).sort(),o=n.options[0];n.innerHTML="",n.appendChild(o),t.forEach(a=>{const s=document.createElement("option");s.value=a,s.textContent=a,i.filters.categoria===a&&(s.selected=!0),n.appendChild(s)})}function _e(n){let e=[...n];return i.filters.conta&&(e=e.filter(t=>t.conta&&t.conta.trim()===i.filters.conta)),(i.filters.dataInicio||i.filters.dataFim)&&(e=e.filter(t=>{if(!t.data)return!1;let o=null;if(typeof t.data=="number")o=w(t.data),o&&o.setHours(0,0,0,0);else if(typeof t.data=="string"){const a=t.data.split(" ")[0].split("/");if(a.length===3){const[s,r,l]=a;o=new Date(parseInt(l),parseInt(r)-1,parseInt(s)),o.setHours(0,0,0,0)}}if(!o||isNaN(o.getTime()))return!1;if(i.filters.dataInicio){const[a,s,r]=i.filters.dataInicio.split("-").map(Number),l=new Date(a,s-1,r);if(l.setHours(0,0,0,0),o<l)return!1}if(i.filters.dataFim){const[a,s,r]=i.filters.dataFim.split("-").map(Number),l=new Date(a,s-1,r);if(l.setHours(23,59,59,999),o>l)return!1}return!0})),i.filters.categoria&&(e=e.filter(t=>t.categoria&&t.categoria.trim()===i.filters.categoria)),i.filters.orcamento&&(e=e.filter(t=>{if(!t.orcamento)return!1;let o="";if(typeof t.orcamento=="number"){const a=w(t.orcamento);a&&(o=`${String(a.getMonth()+1).padStart(2,"0")}/${a.getFullYear()}`)}else typeof t.orcamento=="string"&&(o=t.orcamento.trim());return o===i.filters.orcamento})),e}function we(){const n=document.getElementById("filterConta"),e=document.getElementById("filterDataInicio"),t=document.getElementById("filterDataFim"),o=document.getElementById("filterCategoria"),a=document.getElementById("filterOrcamento");n&&(i.filters.conta=n.value),e&&(i.filters.dataInicio=e.value),t&&(i.filters.dataFim=t.value),o&&(i.filters.categoria=o.value),a&&(i.filters.orcamento=a.value),_(),v();const s=[i.filters.conta,i.filters.dataInicio,i.filters.dataFim,i.filters.categoria,i.filters.orcamento].filter(r=>r).length;s>0&&b(`${s} filtro(s) aplicado(s)`,"success")}function Ie(){i.filters={conta:"",dataInicio:"",dataFim:"",orcamento:"",categoria:""};const n=document.getElementById("filterConta"),e=document.getElementById("filterDataInicio"),t=document.getElementById("filterDataFim"),o=document.getElementById("filterOrcamento"),a=document.getElementById("filterCategoria");n&&(n.value=""),e&&(e.value=""),t&&(t.value=""),o&&(o.value=""),a&&(a.value=""),_(),v(),b("Filtros limpos","info")}function Be(n){const e=i.originalEntries.find(t=>t.rowIndex===n);e?ie(e):console.error("Lançamento não encontrado:",n)}function Ce(n){const e=i.originalEntries.find(t=>t.rowIndex===n);if(e){const t={conta:e.conta,valor:e.valor,descricao:e.descricao,categoria:e.categoria,orcamento:e.orcamento,obs:e.obs};Y(t)}else console.error("Lançamento não encontrado para copiar:",n)}let B=null;function Le(n){const e=i.originalEntries.find(l=>l.rowIndex===n);if(!e){console.error("Lançamento não encontrado:",n);return}B=n;const t=document.getElementById("deleteRowNumber"),o=document.getElementById("deleteDate"),a=document.getElementById("deleteValue"),s=document.getElementById("deleteDescription");if(t&&(t.textContent=String(e.rowIndex||"-")),o){let l="-";e.data&&(typeof e.data=="number"?l=T(e.data):typeof e.data=="string"&&(l=e.data)),o.textContent=l}a&&(a.textContent=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e.valor)),s&&(s.textContent=e.descricao||"-");const r=document.getElementById("deleteModal");r&&(r.style.display="flex")}function O(){B=null;const n=document.getElementById("deleteModal");n&&(n.style.display="none")}async function Se(){if(B===null){console.error("Nenhum lançamento pendente para exclusão");return}const n=B,e=document.getElementById("deleteConfirmBtn");e&&(e.disabled=!0,e.textContent="Excluindo...");try{await E.deleteEntry(n),b("Lançamento excluído com sucesso","success"),O(),await h()}catch(t){console.error("Erro ao deletar lançamento:",t),b("Erro ao deletar lançamento: "+t.message,"error")}finally{e&&(e.disabled=!1,e.textContent="Excluir")}}function Fe(n){Le(n)}window.editEntry=Be;window.copyEntry=Ce;window.deleteEntry=Fe;window.lancamentosManager={closeDeleteModal:O,confirmDelete:Se,closeSplitModal:()=>{const n=document.getElementById("splitModal");n&&(n.style.display="none")},confirmSplit:()=>{console.warn("Funcionalidade de divisão de parcelas não implementada")}};async function D(){if(console.log("[Lançamentos] Inicializando página..."),!await q()){console.warn("⚠️ Token inválido ou usuário não autenticado");return}j(),await G(d=>{console.log("✅ Lançamento adicionado:",d),h()}),await ae(d=>{console.log("✅ Lançamento editado:",d),h()}),await J(d=>{console.log("✅ Lançamento futuro adicionado:",d),h()}),await K(d=>{console.log("✅ Transferência realizada:",d),h()}),Q(()=>F(),()=>Z(),()=>X());const e=document.getElementById("openAddEntryModalBtn");e&&e.addEventListener("click",()=>{console.log("🔓 Abrindo modal de adicionar lançamento..."),F()});const t=document.getElementById("refreshEntriesBtn");t&&t.addEventListener("click",async()=>{console.log("🔄 Atualizando lançamentos (forceRefresh=true)...");const d=t.innerHTML;t.disabled=!0,t.innerHTML="⏳ Atualizando...";try{await h(!0)}finally{t.disabled=!1,t.innerHTML=d}});const o=document.getElementById("searchInput");o&&o.addEventListener("input",d=>{L(d.target.value)});const a=document.getElementById("clearSearchBtn");a&&a.addEventListener("click",()=>{ye()});const s=document.getElementById("sortSelect");s&&(s.value=i.sortBy,s.addEventListener("change",d=>{fe(d.target.value)}));const r=document.getElementById("showConsolidatedCheck");r&&(r.checked=i.showConsolidated,r.addEventListener("change",d=>{ge(d.target.checked)}));const l=document.getElementById("showFutureCheck");l&&(l.checked=i.showFuture,l.addEventListener("change",d=>{pe(d.target.checked)}));const u=document.getElementById("openFilterPanel");u&&u.addEventListener("click",()=>{console.log("🔍 Abrindo painel de filtros..."),Ee()});const c=document.getElementById("closeFilterPanel");c&&c.addEventListener("click",()=>{console.log("❌ Fechando painel de filtros..."),_()});const m=document.getElementById("filterPanelOverlay");m&&m.addEventListener("click",()=>{console.log("🖱️ Clique no overlay - fechando painel de filtros..."),_()});const g=document.getElementById("applyFiltersBtn");g&&g.addEventListener("click",()=>{console.log("✅ Aplicando filtros..."),we()});const f=document.getElementById("clearFiltersBtn");f&&f.addEventListener("click",()=>{console.log("🧹 Limpando filtros..."),Ie()}),document.addEventListener("keydown",d=>{d.key==="Escape"&&i.filterPanelOpen&&_()}),document.addEventListener("entry:edited",()=>{console.log("📝 Entrada editada, recarregando..."),setTimeout(()=>{h()},300)}),await h(),se(i.originalEntries),xe(),console.log("✅ Página de lançamentos inicializada")}function xe(){const n=new URLSearchParams(window.location.search),e=n.get("conta"),t=n.get("categoria");e?(console.log("[Lançamentos] Filtrando por conta:",e),L(e)):t&&(console.log("[Lançamentos] Filtrando por categoria:",t),L(t));const o=document.getElementById("searchInput");o&&(e||t)&&(o.value=e||t||"")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",D):D();
