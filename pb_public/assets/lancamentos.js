var $=Object.defineProperty;var F=(a,e,t)=>e in a?$(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var g=(a,e,t)=>F(a,typeof e!="symbol"?e+"":e,t);import{p as f}from"./auth.js";/* empty css          */import{r as O}from"./user-menu.js";import{a as p,d as N,b as V,f as j,e as q,i as z,o as S,c as R}from"./date-helpers.js";class U{async fetchEntries(e=100){if(!f)throw new Error("PocketBase não inicializado");try{const t=await fetch(`${f.baseUrl}/get-sheet-entries?limit=${e}`,{method:"GET",headers:{Authorization:`Bearer ${f.authStore.token}`,"Content-Type":"application/json"}}),n=await t.json();if(!t.ok)throw new Error(n.error||"Erro ao carregar entradas da planilha");return n}catch(t){throw console.error("Erro ao buscar entradas da planilha:",t),t}}async editEntry(e,t){if(!f)throw new Error("PocketBase não inicializado");try{const n=await fetch(`${f.baseUrl}/edit-sheet-entry`,{method:"PUT",headers:{Authorization:`Bearer ${f.authStore.token}`,"Content-Type":"application/json"},body:JSON.stringify({rowIndex:e,...t})}),o=await n.json();if(!n.ok)throw new Error(o.error||"Erro ao editar lançamento");return o}catch(n){throw console.error("Erro ao editar lançamento:",n),n}}async deleteEntry(e){if(!f)throw new Error("PocketBase não inicializado");try{const t=await fetch(`${f.baseUrl}/delete-sheet-entry`,{method:"DELETE",headers:{Authorization:`Bearer ${f.authStore.token}`,"Content-Type":"application/json"},body:JSON.stringify({rowIndex:e})}),n=await t.json();if(!t.ok)throw new Error(n.error||"Erro ao deletar lançamento");return n}catch(t){throw console.error("Erro ao deletar lançamento:",t),t}}isBlankEntry(e){return e?["data","conta","valor","descricao","categoria","orcamento","obs"].every(n=>{const o=e[n];return o==null?!0:typeof o=="number"?!1:String(o).trim()===""}):!0}normalizeEntry(e){const t={...e};if(typeof t.data=="number"){const n=p(t.data);n&&(t.data=n.toISOString())}if(typeof t.orcamento=="number"){const n=p(t.orcamento);n&&(t.orcamento=n.toISOString().split("T")[0])}return t}sortEntries(e,t){const n=[...e];return t==="original"?n.sort((o,l)=>(l.rowIndex||0)-(o.rowIndex||0)):t==="date"?n.sort((o,l)=>{const r=this.getDateValue(o.data);return this.getDateValue(l.data)-r}):t==="budget_date"?n.sort((o,l)=>{const r=this.getDateValue(o.orcamento),s=this.getDateValue(l.orcamento);if(r!==s)return s-r;const c=this.getDateValue(o.data);return this.getDateValue(l.data)-c}):n}getDateValue(e){if(!e)return Number.MAX_SAFE_INTEGER;if(typeof e=="number")return e;const t=new Date(e);return isNaN(t.getTime())?Number.MAX_SAFE_INTEGER:t.getTime()}filterEntries(e,t){if(!t||t.trim()==="")return e;const n=t.toLowerCase().trim();return e.filter(o=>{const l=this.formatDateForSearch(o.data),r=String(o.valor||""),s=String(o.descricao||"").toLowerCase(),c=String(o.categoria||"").toLowerCase(),m=String(o.conta||"").toLowerCase(),d=String(o.obs||"").toLowerCase();return l.includes(n)||r.includes(n)||s.includes(n)||c.includes(n)||m.includes(n)||d.includes(n)})}formatDateForSearch(e){if(!e)return"";let t=null;if(typeof e=="number"?t=p(e):t=new Date(e),!t||isNaN(t.getTime()))return"";const n=String(t.getDate()).padStart(2,"0"),o=String(t.getMonth()+1).padStart(2,"0"),l=t.getFullYear();return`${n}/${o}/${l}`}getUniqueAccounts(e){const t=new Set;return e.forEach(n=>{n.conta&&typeof n.conta=="string"&&t.add(n.conta.trim())}),Array.from(t).sort()}getUniqueCategories(e){const t=new Set;return e.forEach(n=>{n.categoria&&typeof n.categoria=="string"&&t.add(n.categoria.trim())}),Array.from(t).sort()}getUniqueDescriptions(e){const t=new Set;return e.forEach(n=>{n.descricao&&typeof n.descricao=="string"&&t.add(n.descricao.trim())}),Array.from(t).sort()}}const u=new U;let E=null;class P{constructor(){g(this,"modal",null);g(this,"form",null);g(this,"callback");g(this,"currentEntry",null);g(this,"accounts",[]);g(this,"categories",[]);g(this,"descriptions",[]);g(this,"entries",[])}getTemplate(){return`
  ...
  `}function K(a){return`
    ${X(a)}
    ${Y(a)}
  `}const i={entries:[],filteredEntries:[],originalEntries:[],searchTerm:"",sortBy:"original",hideBlankDates:!0,isLoading:!1};function Q(){const a=document.getElementById("loadingIndicator");a&&(a.style.display="flex")}function W(){const a=document.getElementById("loadingIndicator");a&&(a.style.display="none")}function b(a,e="info"){const t=document.getElementById("messageContainer");if(!t)return;const n=document.createElement("div");n.className=`lancamentos__message lancamentos__message--${e}`,n.textContent=a,t.innerHTML="",t.appendChild(n),setTimeout(()=>{n.remove()},5e3)}function Z(){const a=document.getElementById("searchResults"),e=document.getElementById("searchCount"),t=document.getElementById("clearSearchBtn");!a||!e||!t||(i.searchTerm?(e.textContent=`${i.filteredEntries.length} resultado(s) encontrado(s)`,a.classList.add("lancamentos__search-results--visible"),t.style.display="flex"):(a.classList.remove("lancamentos__search-results--visible"),t.style.display="none"))}async function y(){if(!i.isLoading){i.isLoading=!0,i.entries=[],w(),Q();try{const t=((await u.fetchEntries(100)).entries||[]).filter(n=>!u.isBlankEntry(n));i.originalEntries=t,i.entries=[...i.originalEntries],h(),b("Lançamentos carregados com sucesso","success")}catch(a){console.error("Erro ao carregar lançamentos:",a),b("Erro ao carregar lançamentos: "+a.message,"error"),i.entries=[],i.filteredEntries=[],w()}finally{i.isLoading=!1,W()}}}function h(){let a=[...i.originalEntries];i.hideBlankDates&&(a=a.filter(e=>!(e.data===null||e.data===void 0||typeof e.data=="string"&&e.data.trim()===""))),a=u.sortEntries(a,i.sortBy),i.searchTerm&&(a=u.filterEntries(a,i.searchTerm)),i.filteredEntries=a,i.entries=i.sortBy==="original"?[...i.originalEntries]:u.sortEntries([...i.originalEntries],i.sortBy),w(),Z()}function w(){const a=document.getElementById("entriesContainer");if(!a)return;const e=i.searchTerm||i.filteredEntries.length>0?i.filteredEntries:i.entries;a.innerHTML=K(e)}function ee(a){i.sortBy=a,h()}function te(a){i.hideBlankDates=a,h()}function ne(a){i.searchTerm=a.trim(),h()}function ae(){const a=document.getElementById("searchInput");a&&(a.value=""),i.searchTerm="",h()}function oe(a){const e=i.entries.find(t=>t.rowIndex===a);e?G(e):console.error("Lançamento não encontrado:",a)}let _=null;function se(a){const e=i.entries.find(s=>s.rowIndex===a);if(!e){console.error("Lançamento não encontrado:",a);return}_=a;const t=document.getElementById("deleteRowNumber"),n=document.getElementById("deleteDate"),o=document.getElementById("deleteValue"),l=document.getElementById("deleteDescription");t&&(t.textContent=String(e.rowIndex||"-")),n&&(n.textContent=String(e.data||"-")),o&&(o.textContent=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e.valor)),l&&(l.textContent=e.descricao||"-");const r=document.getElementById("deleteModal");r&&(r.style.display="flex")}function k(){_=null;const a=document.getElementById("deleteModal");a&&(a.style.display="none")}async function ie(){if(_===null){console.error("Nenhum lançamento pendente para exclusão");return}const a=_,e=document.getElementById("deleteConfirmBtn");e&&(e.disabled=!0,e.textContent="Excluindo...");try{await u.deleteEntry(a),b("Lançamento excluído com sucesso","success"),k(),await y()}catch(t){console.error("Erro ao deletar lançamento:",t),b("Erro ao deletar lançamento: "+t.message,"error")}finally{e&&(e.disabled=!1,e.textContent="Excluir")}}function re(a){se(a)}window.editEntry=oe;window.deleteEntry=re;window.lancamentosManager={closeDeleteModal:k,confirmDelete:ie,closeSplitModal:()=>{const a=document.getElementById("splitModal");a&&(a.style.display="none")},confirmSplit:()=>{console.warn("Funcionalidade de divisão de parcelas não implementada")}};async function I(){console.log("[Lançamentos] Inicializando página..."),O(),await z(s=>{console.log("✅ Lançamento adicionado:",s),y()}),await H(s=>{console.log("✅ Lançamento editado:",s),y()});const a=document.getElementById("openAddEntryModalBtn"),e=document.getElementById("openEntryModal");a&&a.addEventListener("click",()=>{console.log("🔓 Abrindo modal de adicionar lançamento..."),S()}),e&&e.addEventListener("click",()=>{console.log("🔓 Toggle modal de adicionar lançamento (FAB)...");const s=document.getElementById("entryModal");(s==null?void 0:s.style.display)==="flex"?R():S()});const t=document.getElementById("refreshEntriesBtn");t&&t.addEventListener("click",()=>{console.log("🔄 Atualizando lançamentos..."),y()});const n=document.getElementById("searchInput");n&&n.addEventListener("input",s=>{ne(s.target.value)});const o=document.getElementById("clearSearchBtn");o&&o.addEventListener("click",()=>{ae()});const l=document.getElementById("sortSelect");l&&(l.value=i.sortBy,l.addEventListener("change",s=>{ee(s.target.value)}));const r=document.getElementById("hideBlankDatesCheck");r&&(r.checked=i.hideBlankDates,r.addEventListener("change",s=>{te(s.target.checked)})),document.addEventListener("entry:edited",()=>{console.log("📝 Entrada editada, recarregando..."),setTimeout(()=>{y()},300)}),await y(),J(i.entries),console.log("✅ Página de lançamentos inicializada")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",I):I();
